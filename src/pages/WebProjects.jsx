  ...
  return (
    <div>
      <h3 className="text-xl text-center md:text-3xl font-bold brightness-150 text-neutral-500 mt-2 md:mt-7">
        Web <span className="text-textcolor brightness-150">Projects</span> 
      </h3>
    <motion.div
      className="flex flex-col p-2 md:p-4 mt-4 gap-4 "
    ...
    >
      {webProjects.map((elem, idx) => (
        <motion.a
          ...
          target="_blank"
          key={idx}
          className="p-2 md:p-4 h-54 w-full gap-4 rounded-lg bg-neutral-950 brightness-150 flex flex-col md:flex-row justify-between items-center transition-transform duration-300 ease-in-out outline-1 outline-textcolor shadow-textcolor"
        ...
        >
          ...
          <div className="flex flex-col md:gap-2">
            <h2 className="text-md md:text-xl font-bold text-textcolor">{elem.name}</h2>
            <p className="text-neutral-500 max-w-2xl hidden sm:block">{elem.description}</p>
